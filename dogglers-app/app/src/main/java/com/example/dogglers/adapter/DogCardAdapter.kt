...
class DogCardAdapter(
    ...
    class DogCardViewHolder(view: View?): RecyclerView.ViewHolder(view!!) {
        val dogImageView: ImageView? = view!!.findViewById(R.id.img)
        val dogNameTextView: TextView? = view!!.findViewById(R.id.name)
        val dogAgeTextView: TextView? = view!!.findViewById(R.id.age)
        val dogHobbyTextView: TextView? = view!!.findViewById(R.id.hobby    )
    }
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): DogCardViewHolder {
        ...
        //  the inflated layout.
        return DogCardViewHolder(setLayout)
    }

    override fun getItemCount(): Int { return listDogs.size }// return the size of the data set instead of 0

    override fun onBindViewHolder(holder: DogCardViewHolder, position: Int) {
        // Get the data at the current position
        val dogData = listDogs[position]
